<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="#"><i class="fas fa-envelope"></i>ariqalhafizh@gmail.com</a>
         <a href="#"><i class="fas fa-map-marker-alt"></i> Bandung , indonesia - 185421 </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>AriqProgramming</span> | all rights reserved!</div>
